...
insert into conta values('A-102', 'Sao Paulo', 400);
...
insert into agencia values('Sao Paulo', 'Sao Paulo', 1700000);
...
insert into emprestimo values('L-155', 'Sao Paulo', 1500);
insert into emprestimo values('L-160', 'Sao Paulo', 1300);
...
insert into mutuario values('Jones', 'L-165');
insert into mutuario values('Smith', 'L-110');
insert into mutuario values('Smith', 'L-230');
insert into mutuario values('Williams', 'L-170');

insert into funcionario values('Adams', 'Sao Paulo', 1500);
insert into funcionario values('Brown', 'Sao Paulo', 1300);
insert into funcionario values('Gopal', 'Sao Paulo', 5300);
